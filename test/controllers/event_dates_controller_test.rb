...
class EventDatesControllerTest < ActionController::TestCase
  ...
  test "should create event_date" do
    assert_difference('EventDate.count') do
      post :create, event_date: { comment: @event_date.comment, date: @event_date.date, event_id: @event_date.event_id }
    end
  ...
  test "should update event_date" do
    patch :update, id: @event_date, event_date: { comment: @event_date.comment, date: @event_date.date, event_id: @event_date.event_id }
    assert_redirected_to event_date_path(assigns(:event_date))
  end
